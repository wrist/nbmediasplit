...
def cuitest(c):
    ...
    c.run("poetry run nbmediasplit -n test/test.ipynb -i test/img")
    print(os.listdir("test/img"))
    shutil.rmtree("test/img")

    print("audio extract test")
    c.run("poetry run nbmediasplit -n test/test.ipynb -w test/wav")
    print(os.listdir("test/wav"))
    shutil.rmtree("test/wav")

    print("both extract test")
    c.run("poetry run nbmediasplit -n test/test.ipynb -i test/img -w test/wav")
    print(os.listdir("test/img"))
    print(os.listdir("test/wav"))
    shutil.rmtree("test/wav")
    shutil.rmtree("test/img")
    ...
    c.run("poetry run nbmediasplit -n test/test.ipynb -i test/img -w test/wav -o test/test.converted.ipynb --img-prefix img --wav-prefix wav")
